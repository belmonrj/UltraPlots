...
void doit(int centid1=0, int centid2=4)
{
  ...
  float pt[18],
    yieldcent[18], eyieldcent[18], esysyieldcent[18],
    yieldperi[18], eyieldperi[18], esysyieldperi[18],
    ratio[18], eratio[18], esysratio[18];
  float tmp;


  float Ncoll[5] = {955.4,602.6,296.8,90.6,14.5};//AN169 numbers for Run2&4

  sprintf(filenamecent,"ppg080_cent%s.dat",centstring1);
  sprintf(filenameperi,"ppg080_cent%s.dat",centstring2);
  sprintf(filenameOUT,"ppg080_RCP_c%d%d.dat",centid1,centid2);
