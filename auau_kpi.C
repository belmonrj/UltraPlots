void auau_kpi()
{
  ...
  ifstream fauau0010("../Run7AuAu/Ratios/regular/kpi_04_cent0010.txt");
  for(int i=0; i<36; i++)
    {
  ...
  ifstream fauau1020("../Run7AuAu/Ratios/regular/kpi_04_cent1020.txt");
  for(int i=0; i<36; i++)
    {
  ...
  ifstream fauau2040("../Run7AuAu/Ratios/regular/kpi_04_cent2040.txt");
  for(int i=0; i<36; i++)
    {
  ...
  ifstream fauau4060("../Run7AuAu/Ratios/regular/kpi_04_cent4060.txt");
  for(int i=0; i<36; i++)
    {
  ...
  ifstream fauau6092("../Run7AuAu/Ratios/regular/kpi_04_cent6092.txt");
  for(int i=0; i<36; i++)
    {
  ...
  tmgpos1->GetXaxis()->SetLimits(0.0,4.0);
  tmgpos1->GetXaxis()->SetTitle("p_{T} (GeV/c)");
  tmgpos1->GetXaxis()->CenterTitle();
  tmgpos1->GetYaxis()->SetTitle("Ratio K/#pi");
  ...
  legpos1->AddEntry(tge_ratiopos_auau0010,"K^{+}/#pi^{+} Au+Au 0-10%","p");
  legpos1->AddEntry(tge_ratiopos_auau1020,"K^{+}/#pi^{+} Au+Au 10-20%","p");
  legpos1->AddEntry(tge_ratiopos_auau2040,"K^{+}/#pi^{+} Au+Au 20-40%","p");
  legpos1->AddEntry(tge_ratiopos_auau4060,"K^{+}/#pi^{+} Au+Au 40-60%","p");
  legpos1->AddEntry(tge_ratiopos_auau6092,"K^{+}/#pi^{+} Au+Au 60-92%","p");
  ...
  tmgneg1->GetXaxis()->SetLimits(0.0,4.0);
  tmgneg1->GetXaxis()->SetTitle("p_{T} (GeV/c)");
  tmgneg1->GetXaxis()->CenterTitle();
  tmgneg1->GetYaxis()->SetTitle("Ratio K/#pi");
  ...
  legneg1->AddEntry(tge_rationeg_auau0010,"K^{-}/#pi^{-} Au+Au 0-10%","p");
  legneg1->AddEntry(tge_rationeg_auau1020,"K^{-}/#pi^{-} Au+Au 10-20%","p");
  legneg1->AddEntry(tge_rationeg_auau2040,"K^{-}/#pi^{-} Au+Au 20-40%","p");
  legneg1->AddEntry(tge_rationeg_auau4060,"K^{-}/#pi^{-} Au+Au 40-60%","p");
  legneg1->AddEntry(tge_rationeg_auau6092,"K^{-}/#pi^{-} Au+Au 60-92%","p");
  legneg1->SetTextSize(0.05);
  //legneg1->Draw();
  ...
  //lg11->Draw(); // comment from Jamie Nagle
  ...
  c1->Print("figures/auau_kpi_both.gif");
  c1->Print("figures/auau_kpi_both.eps");
  ...
  tlpos2->Draw();
  TLatex *tlsys = new TLatex(0.3,0.85*MAX,"Au+Au #sqrt{s_{NN}} = 200 GeV");
  ...
  c2->Print("figures/auau_kpi_voth.gif");
  c2->Print("figures/auau_kpi_voth.eps");
