void pipi()
{
  ...
  tge_pipi0088dAu->SetMarkerStyle(kOpenSquare);
  ...
  tge_pipi2040dAu->SetMarkerStyle(kOpenTriangleUp);
  ...
  tge_pipi0010AuAu->SetMaximum(2.0);
  tge_pipi0010AuAu->SetMinimum(0.0);
  tge_pipi0010AuAu->GetXaxis()->SetLimits(0.0,6.0);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  leg->AddEntry(tge_pipi0010AuAu,"Au+Au 0-10%","p");
  leg->Draw("same");
  line = new TLine(0.0,1.0,6.0,1.0);
  line->Draw("same");

  c1->cd(3);
  tge_pipi1020AuAu->Draw("apz");
  tge_pipi1020AuAu->SetMaximum(2.0);
  tge_pipi1020AuAu->SetMinimum(0.0);
  tge_pipi1020AuAu->GetXaxis()->SetLimits(0.0,6.0);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_pipi2040AuAu->SetMaximum(2.0);
  tge_pipi2040AuAu->SetMinimum(0.0);
  tge_pipi2040AuAu->GetXaxis()->SetLimits(0.0,6.0);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_pipi4060AuAu->SetMaximum(2.0);
  tge_pipi4060AuAu->SetMinimum(0.0);
  tge_pipi4060AuAu->GetXaxis()->SetLimits(0.0,6.0);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_pipi6092AuAu->SetMaximum(2.0);
  tge_pipi6092AuAu->SetMinimum(0.0);
  tge_pipi6092AuAu->GetXaxis()->SetLimits(0.0,6.0);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_pipi0020dAu->SetMaximum(2.0);
  tge_pipi0020dAu->SetMinimum(0.0);
  tge_pipi0020dAu->GetXaxis()->SetLimits(0.0,6.0);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_pipi2040dAu->SetMaximum(2.0);
  tge_pipi2040dAu->SetMinimum(0.0);
  tge_pipi2040dAu->GetXaxis()->SetLimits(0.0,6.0);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_pipi0088dAu->SetMaximum(2.0);
  tge_pipi0088dAu->SetMinimum(0.0);
  tge_pipi0088dAu->GetXaxis()->SetLimits(0.0,6.0);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_pipi4060dAu->SetMaximum(2.0);
  tge_pipi4060dAu->SetMinimum(0.0);
  tge_pipi4060dAu->GetXaxis()->SetLimits(0.0,6.0);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_pipi6088dAu->SetMaximum(2.0);
  tge_pipi6088dAu->SetMinimum(0.0);
  tge_pipi6088dAu->GetXaxis()->SetLimits(0.0,6.0);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
