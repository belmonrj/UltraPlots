void all_ppi()
{
  ...
  tmgpos2->Add(tge_ratiopos_auau0010);
  tmgpos2->Add(tge_ratiopos_auau1020);
  tmgpos2->Add(tge_ratiopos_auau2040);
  tmgpos2->Add(tge_ratiopos_auau4060);
  tmgpos2->Add(tge_ratiopos_auau6092);
  ...
  legpos2->AddEntry(tge_ratiopos_auau0010,"p/#pi^{+} Au+Au 0-10%","p");
  legpos2->AddEntry(tge_ratiopos_auau1020,"p/#pi^{+} Au+Au 10-20%","p");
  legpos2->AddEntry(tge_ratiopos_auau2040,"p/#pi^{+} Au+Au 20-40%","p");
  legpos2->AddEntry(tge_ratiopos_auau4060,"p/#pi^{+} Au+Au 40-60%","p");
  legpos2->AddEntry(tge_ratiopos_auau6092,"p/#pi^{+} Au+Au 60-92%","p");
  legpos2->Draw();
