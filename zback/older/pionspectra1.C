void pionspectra1()
{
  ...
  for(int i=0; i<36; i++)
	...
	{ 
      ...
      yield_pospion0020dAu[i] *= 1.3e-1;eyield_pospion0020dAu[i] *= 1.3e-1;
      yield_pospion0088dAu[i] *= 5.0e-2;eyield_pospion0088dAu[i] *= 5.0e-2;
  ...
  tge_pospion0088dAu->SetMarkerStyle(kOpenSquare);
  ...
  tge_pospion2040dAu->SetMarkerStyle(kOpenTriangleUp);
  ...
  for(int i=0; i<36; i++)
	...
	{ 
      ...
      yield_negpion0088dAu[i] *= 5.0e-2;eyield_negpion0088dAu[i] *= 5.0e-2;
      yield_negpion2040dAu[i] *= 7.5e-3;eyield_negpion2040dAu[i] *= 7.5e-3;
  ...
  tge_negpion0088dAu->SetMarkerStyle(kOpenSquare);
  ...
  tge_negpion2040dAu->SetMarkerStyle(kOpenTriangleUp);
