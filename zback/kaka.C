void kaka()
{
  ...
  TGraphErrors *tge_kaka0010AuAu = new TGraphErrors(32,pT_kaka0010AuAu,ratio_kaka0010AuAu,epT_kaka0010AuAu,eratio_kaka0010AuAu);
  tge_kaka0010AuAu->SetMarkerColor(kBlack);
  tge_kaka0010AuAu->SetMarkerStyle(kFullCircle);
  TGraphErrors *tge_kaka1020AuAu = new TGraphErrors(32,pT_kaka1020AuAu,ratio_kaka1020AuAu,epT_kaka1020AuAu,eratio_kaka1020AuAu);
  tge_kaka1020AuAu->SetMarkerColor(kBlack);
  tge_kaka1020AuAu->SetMarkerStyle(kFullSquare);
  TGraphErrors *tge_kaka2040AuAu = new TGraphErrors(32,pT_kaka2040AuAu,ratio_kaka2040AuAu,epT_kaka2040AuAu,eratio_kaka2040AuAu);
  tge_kaka2040AuAu->SetMarkerColor(kBlack);
  tge_kaka2040AuAu->SetMarkerStyle(kFullTriangleUp);
  TGraphErrors *tge_kaka4060AuAu = new TGraphErrors(32,pT_kaka4060AuAu,ratio_kaka4060AuAu,epT_kaka4060AuAu,eratio_kaka4060AuAu);
  tge_kaka4060AuAu->SetMarkerColor(kBlack);
  tge_kaka4060AuAu->SetMarkerStyle(kFullTriangleDown);
  TGraphErrors *tge_kaka6092AuAu = new TGraphErrors(32,pT_kaka6092AuAu,ratio_kaka6092AuAu,epT_kaka6092AuAu,eratio_kaka6092AuAu);
  tge_kaka6092AuAu->SetMarkerColor(kBlack);
  tge_kaka6092AuAu->SetMarkerStyle(kFullDiamond);

  TGraphErrors *tge_kaka0088dAu = new TGraphErrors(31,pT_kaka0088dAu,ratio_kaka0088dAu,epT_kaka0088dAu,eratio_kaka0088dAu);
  tge_kaka0088dAu->SetMarkerColor(kBlack);
  tge_kaka0088dAu->SetMarkerStyle(kOpenTriangleUp);
  TGraphErrors *tge_kaka0020dAu = new TGraphErrors(31,pT_kaka0020dAu,ratio_kaka0020dAu,epT_kaka0020dAu,eratio_kaka0020dAu);
  tge_kaka0020dAu->SetMarkerColor(kBlack);
  tge_kaka0020dAu->SetMarkerStyle(kOpenCircle);
  TGraphErrors *tge_kaka2040dAu = new TGraphErrors(31,pT_kaka2040dAu,ratio_kaka2040dAu,epT_kaka2040dAu,eratio_kaka2040dAu);
  tge_kaka2040dAu->SetMarkerColor(kBlack);
  tge_kaka2040dAu->SetMarkerStyle(kOpenSquare);
  TGraphErrors *tge_kaka4060dAu = new TGraphErrors(31,pT_kaka4060dAu,ratio_kaka4060dAu,epT_kaka4060dAu,eratio_kaka4060dAu);
  tge_kaka4060dAu->SetMarkerColor(kBlack);
  tge_kaka4060dAu->SetMarkerStyle(kOpenTriangleDown);
  TGraphErrors *tge_kaka6088dAu = new TGraphErrors(31,pT_kaka6088dAu,ratio_kaka6088dAu,epT_kaka6088dAu,eratio_kaka6088dAu);
  ...
  tge_kaka0010AuAu->SetMaximum(MAXY);
  tge_kaka0010AuAu->SetMinimum(MINY);
  tge_kaka0010AuAu->GetXaxis()->SetLimits(MINX,MAXX);
  tge_kaka0010AuAu->GetYaxis()->SetLabelSize(0.12);
  tge_kaka0010AuAu->GetXaxis()->SetLabelSize(0.12);
  tge_kaka0010AuAu->GetYaxis()->SetNdivisions(505);
  //tge_kaka0010AuAu->GetXaxis()->SetNdivisions(505);
  ...
  tge_kaka1020AuAu->SetMaximum(MAXY);
  tge_kaka1020AuAu->SetMinimum(MINY);
  tge_kaka1020AuAu->GetXaxis()->SetLimits(MINX,MAXX);
  tge_kaka1020AuAu->GetYaxis()->SetLabelSize(0.12);
  tge_kaka1020AuAu->GetXaxis()->SetLabelSize(0.12);
  tge_kaka1020AuAu->GetYaxis()->SetNdivisions(505);
  //tge_kaka1020AuAu->GetXaxis()->SetNdivisions(505);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_kaka2040AuAu->SetMaximum(MAXY);
  tge_kaka2040AuAu->SetMinimum(MINY);
  tge_kaka2040AuAu->GetXaxis()->SetLimits(MINX,MAXX);
  tge_kaka2040AuAu->GetYaxis()->SetLabelSize(0.12);
  tge_kaka2040AuAu->GetXaxis()->SetLabelSize(0.12);
  tge_kaka2040AuAu->GetYaxis()->SetNdivisions(505);
  //tge_kaka2040AuAu->GetXaxis()->SetNdivisions(505);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_kaka4060AuAu->SetMaximum(MAXY);
  tge_kaka4060AuAu->SetMinimum(MINY);
  tge_kaka4060AuAu->GetXaxis()->SetLimits(MINX,MAXX);
  tge_kaka4060AuAu->GetYaxis()->SetLabelSize(0.12);
  tge_kaka4060AuAu->GetXaxis()->SetLabelSize(0.12);
  tge_kaka4060AuAu->GetYaxis()->SetNdivisions(505);
  //tge_kaka4060AuAu->GetXaxis()->SetNdivisions(505);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_kaka6092AuAu->SetMaximum(MAXY);
  tge_kaka6092AuAu->SetMinimum(MINY);
  tge_kaka6092AuAu->GetXaxis()->SetLimits(MINX,MAXX);
  tge_kaka6092AuAu->GetYaxis()->SetLabelSize(0.12);
  tge_kaka6092AuAu->GetXaxis()->SetLabelSize(0.12);
  tge_kaka6092AuAu->GetYaxis()->SetNdivisions(505);
  //tge_kaka6092AuAu->GetXaxis()->SetNdivisions(505);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_kaka0020dAu->SetMaximum(MAXY);
  tge_kaka0020dAu->SetMinimum(MINY);
  tge_kaka0020dAu->GetXaxis()->SetLimits(MINX,MAXX);
  tge_kaka0020dAu->GetYaxis()->SetLabelSize(0.12);
  tge_kaka0020dAu->GetXaxis()->SetLabelSize(0.12);
  tge_kaka0020dAu->GetYaxis()->SetNdivisions(505);
  //tge_kaka0020dAu->GetXaxis()->SetNdivisions(505);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_kaka2040dAu->SetMaximum(MAXY);
  tge_kaka2040dAu->SetMinimum(MINY);
  tge_kaka2040dAu->GetXaxis()->SetLimits(MINX,MAXX);
  tge_kaka2040dAu->GetYaxis()->SetLabelSize(0.12);
  tge_kaka2040dAu->GetXaxis()->SetLabelSize(0.12);
  tge_kaka2040dAu->GetYaxis()->SetNdivisions(505);
  //tge_kaka2040dAu->GetXaxis()->SetNdivisions(505);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_kaka0088dAu->SetMaximum(MAXY);
  tge_kaka0088dAu->SetMinimum(MINY);
  tge_kaka0088dAu->GetXaxis()->SetLimits(MINX,MAXX);
  tge_kaka0088dAu->GetYaxis()->SetLabelSize(0.12);
  tge_kaka0088dAu->GetXaxis()->SetLabelSize(0.12);
  tge_kaka0088dAu->GetYaxis()->SetNdivisions(505);
  //tge_kaka0088dAu->GetXaxis()->SetNdivisions(505);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_kaka4060dAu->SetMaximum(MAXY);
  tge_kaka4060dAu->SetMinimum(MINY);
  tge_kaka4060dAu->GetXaxis()->SetLimits(MINX,MAXX);
  tge_kaka4060dAu->GetYaxis()->SetLabelSize(0.12);
  tge_kaka4060dAu->GetXaxis()->SetLabelSize(0.12);
  tge_kaka4060dAu->GetYaxis()->SetNdivisions(505);
  //tge_kaka4060dAu->GetXaxis()->SetNdivisions(505);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
  ...
  tge_kaka6088dAu->SetMaximum(MAXY);
  tge_kaka6088dAu->SetMinimum(MINY);
  tge_kaka6088dAu->GetXaxis()->SetLimits(MINX,MAXX);
  tge_kaka6088dAu->GetYaxis()->SetLabelSize(0.12);
  tge_kaka6088dAu->GetXaxis()->SetLabelSize(0.12);
  tge_kaka6088dAu->GetYaxis()->SetNdivisions(505);
  //tge_kaka6088dAu->GetXaxis()->SetNdivisions(505);
  leg = new TLegend(0.48,0.68,0.88,0.88);
  leg->SetBorderSize(0);
  leg->SetFillColor(kWhite);
